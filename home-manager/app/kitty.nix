# @path: ~/projects/configs/nix-config/home-manager/app/kitty.nix
# @author: redskaber
# @datetime: 2025-12-12
# @diractory: https://nix-community.github.io/home-manager/options.xhtml#opt-programs.kitty.enable
